...
- (NSArray *)mpViewControllers {
    ...
    UMengSocialViewController *secondViewController = [[UMengSocialViewController alloc] init];
...
//    MPDiscoveryViewController *thirdViewController = [[MPDiscoveryViewController alloc] init];
