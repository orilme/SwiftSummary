...
open class PopoverView: UIView {
    ...
    private var pCornerRadius: CGFloat = 6.0
    ...
    open func show(_ contentView: UIView, point: CGPoint, inView: UIView) {
        if self.dismissOnBlackOverlayTap || self.showBlackOverlay {
            ...
            if self.dismissOnBlackOverlayTap {
                self.blackOverlay.addTarget(self, action: #selector(PopoverView.dismiss), for: .touchUpInside)
            }
        }
        self.containerView = inView
        self.contentView = contentView
        self.contentView.backgroundColor = UIColor.clear
        self.contentView.layer.cornerRadius = self.pCornerRadius
    ...
    override open func draw(_ rect: CGRect) {
        ...
        case .up:
            ...
            arrow.addLine(to: CGPoint(x: self.pCornerRadius, y: self.bounds.height - self.arrowSize.height))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.pCornerRadius,
                    y: self.bounds.height - self.arrowSize.height - self.pCornerRadius
                ),
                radius: self.pCornerRadius,
                startAngle: self.radians(90),
                endAngle: self.radians(180),
                clockwise: true)
            
            arrow.addLine(to: CGPoint(x: 0, y: self.pCornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.pCornerRadius,
                    y: self.pCornerRadius
                ),
                radius: self.pCornerRadius,
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width - self.pCornerRadius, y: 0))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.pCornerRadius,
                    y: self.pCornerRadius
                ),
                radius: self.pCornerRadius,
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.arrowSize.height - self.pCornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.pCornerRadius,
                    y: self.bounds.height - self.arrowSize.height - self.pCornerRadius
        ...
        case .down, .auto:
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width - self.pCornerRadius, y: self.arrowSize.height))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.pCornerRadius,
                    y: self.arrowSize.height + self.pCornerRadius
                ),
                radius: self.pCornerRadius,
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width, y: self.bounds.height - self.pCornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.pCornerRadius,
                    y: self.bounds.height - self.pCornerRadius
                ),
                radius: self.pCornerRadius,
                startAngle: self.radians(0),
                endAngle: self.radians(90),
            ...
            arrow.addLine(to: CGPoint(x: 0, y: self.arrowSize.height + self.pCornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.pCornerRadius,
                    y: self.arrowSize.height + self.pCornerRadius
        ...
        case .left:
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width - self.arrowSize.width, y: self.bounds.height - self.pCornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.arrowSize.width - self.pCornerRadius,
                    y: self.bounds.height - self.pCornerRadius
                ),
                radius: self.pCornerRadius,
                startAngle: self.radians(0),
            ...
            arrow.addLine(to: CGPoint(x: self.pCornerRadius, y: self.bounds.height))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.pCornerRadius,
                    y: self.bounds.height - self.pCornerRadius
            ...
            arrow.addLine(to: CGPoint(x: self.bounds.width - self.pCornerRadius - arrowSize.width, y: 0))
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.bounds.width - self.pCornerRadius - arrowSize.width,
                    y: self.pCornerRadius
                ),
                radius: self.pCornerRadius,
                startAngle: self.radians(270),
        ...
        case .right:
            ...
            arrow.addLine(to: CGPoint(x: self.arrowSize.width, y: self.pCornerRadius))
            arrow.addArc(
                withCenter: CGPoint(
                    x:self.arrowSize.width + self.pCornerRadius,
                    y: self.pCornerRadius
                ),
                radius: self.pCornerRadius,
                startAngle: self.radians(180),
            ...
            arrow.addArc(
                withCenter: CGPoint(
                    x: self.pCornerRadius + self.arrowSize.width,
                    y: self.bounds.height - self.pCornerRadius
                ),
                radius: self.pCornerRadius,
                startAngle: self.radians(90),
...
public extension PopoverView {
    ...
    func dealPopoverViewFrameInHorizontal(_ frame : CGRect) -> CGRect {
        ...
        if outerSideEdge > 0 {
            tFrame.origin.x -= (outerSideEdge + sideEdge) + 15
        } else {
            if tFrame.minX < 0 {
